...
import { DEFAULT_CATS, PALETTE } from './data.js?v=roller-sep26';
import { load, save, todayStr } from '../../assets/js/storage.js?v=roller-sep26';
import { toast } from '../../assets/js/ui.js?v=roller-sep26';
import { renderNetWorth, nwClick, nwKeydown, nwReset } from './networth.js?v=roller-sep26';
...
export default {
  ...
  name: 'Finance',
  storagePrefix: 'fin_',
  styles: 'apps/finance/finance.css?v=roller-sep26',
