...
import { DEFAULT_CATS, PALETTE } from './data.js?v=decline-sep26';
import { load, save, todayStr } from '../../assets/js/storage.js?v=decline-sep26';
import { toast } from '../../assets/js/ui.js?v=decline-sep26';
import { renderNetWorth, nwClick, nwKeydown, nwReset } from './networth.js?v=decline-sep26';
...
export default {
  ...
  name: 'Finance',
  storagePrefix: 'fin_',
  styles: 'apps/finance/finance.css?v=decline-sep26',
