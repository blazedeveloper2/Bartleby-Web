...
import { DEFAULT_CATS, PALETTE } from './data.js?v=ranks-sep26';
import { load, save, todayStr } from '../../assets/js/storage.js?v=ranks-sep26';
import { toast } from '../../assets/js/ui.js?v=ranks-sep26';
import { renderNetWorth, nwClick, nwKeydown, nwReset } from './networth.js?v=ranks-sep26';
...
export default {
  ...
  name: 'Finance',
  storagePrefix: 'fin_',
  styles: 'apps/finance/finance.css?v=ranks-sep26',
