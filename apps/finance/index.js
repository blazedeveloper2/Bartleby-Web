...
import { DEFAULT_CATS, PALETTE } from './data.js?v=nodrop-sep24';
import { load, save, todayStr } from '../../assets/js/storage.js?v=nodrop-sep24';
import { toast } from '../../assets/js/ui.js?v=nodrop-sep24';
import { renderNetWorth, nwClick, nwKeydown, nwReset } from './networth.js?v=nodrop-sep24';
...
export default {
  ...
  name: 'Finance',
  storagePrefix: 'fin_',
  styles: 'apps/finance/finance.css?v=nodrop-sep24',
