...
import { PROGRAM, WEEK_ORDER, LADDERS, MMAP, PEOPLE, USER } from './data.js?v=gripsrc-sep24';
import { load, save, todayStr, dateStr, USER_KEY } from './store.js?v=gripsrc-sep24';
import { toast } from '../../assets/js/ui.js?v=gripsrc-sep24';
import { pctColor, ord, LIFTS } from './standards.js?v=gripsrc-sep24';
import {
...
import { MUSCLE_SVG } from './bodymap.js?v=gripsrc-sep24';
import { HOWTO } from './howto.js?v=gripsrc-sep24';
import { standingsFor } from './anthro.js?v=gripsrc-sep24';
import { logGrip, delGrip, gripUnit, setGripUnit, fromGU, toGU } from './grip.js?v=gripsrc-sep24';
import {
...
export default {
  ...
  styles: 'apps/workout/workout.css?v=gripsrc-sep24',
