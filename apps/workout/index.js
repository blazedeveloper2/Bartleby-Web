...
import { PROGRAM, MMAP } from './data.js?v=tabs-sep26';
import { load, save, todayStr, dateStr } from '../../assets/js/storage.js?v=tabs-sep26';
import { toast } from '../../assets/js/ui.js?v=tabs-sep26';
import { pctColor, ord } from './standards.js?v=tabs-sep26';
import {
...
} from './rank.js?v=tabs-sep26';
import { MUSCLE_SVG } from './bodymap.js?v=tabs-sep26';
import { standingsFor } from './anthro.js?v=tabs-sep26';
import {
...
export default {
  ...
  name: 'Workout',
  storagePrefix: 'bp_',
  styles: 'apps/workout/workout.css?v=tabs-sep26',
