...
import { PROGRAM, MMAP } from './data.js?v=scale-sep26';
import { load, save, todayStr, dateStr } from '../../assets/js/storage.js?v=scale-sep26';
import { toast } from '../../assets/js/ui.js?v=scale-sep26';
import { pctColor, ord } from './standards.js?v=scale-sep26';
import {
...
} from './rank.js?v=scale-sep26';
import { MUSCLE_SVG } from './bodymap.js?v=scale-sep26';
import { standingsFor } from './anthro.js?v=scale-sep26';
import {
...
export default {
  ...
  name: 'Workout',
  storagePrefix: 'bp_',
  styles: 'apps/workout/workout.css?v=scale-sep26',
