...
import { PROGRAM, MMAP } from './data.js?v=consistency-3';
import { load, save, todayStr, dateStr } from '../../assets/js/storage.js?v=consistency-3';
import { toast } from '../../assets/js/ui.js?v=consistency-3';
import { pctColor, ord } from './standards.js?v=consistency-3';
import {
...
} from './rank.js?v=consistency-3';
import { MUSCLE_SVG } from './bodymap.js?v=consistency-3';
...
export default {
  ...
  name: 'Workout',
  storagePrefix: 'bp_',
  styles: 'apps/workout/workout.css?v=consistency-3',
