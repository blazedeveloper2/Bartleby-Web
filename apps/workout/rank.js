...
import { PROGRAM } from './data.js?v=tags-sep26';
import { LIFTS, SRC_LABEL, TIER_PCT, rankFor, verseFor } from './standards.js?v=tags-sep26';
import { load, save, remove, todayStr, dateStr } from '../../assets/js/storage.js?v=tags-sep26';
