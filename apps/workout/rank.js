...
import { PROGRAM } from './data.js?v=tabs-sep26';
import { LIFTS, SRC_LABEL, TIER_PCT, rankFor, verseFor } from './standards.js?v=tabs-sep26';
import { load, save, remove, todayStr, dateStr } from '../../assets/js/storage.js?v=tabs-sep26';
...
import { weighed, taped, navyBF, prof, snapshot as bodySnap, scoringRef, REF_BF } from './body.js?v=tabs-sep26';
import { checkup } from './checkup.js?v=tabs-sep26';
