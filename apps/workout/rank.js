...
import { PROGRAM } from './data.js?v=perunit2-sep26';
import { LIFTS, SRC_LABEL, TIER_PCT, rankFor, verseFor } from './standards.js?v=perunit2-sep26';
import { load, save, remove, todayStr, dateStr } from '../../assets/js/storage.js?v=perunit2-sep26';
...
import { weighed, snapshot as bodySnap, scoringRef, REF_BF } from './body.js?v=perunit2-sep26';
